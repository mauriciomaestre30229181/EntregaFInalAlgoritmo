...
public class ArchiveUtil {
    ...
    public void setCreateArchive(String content, String nameArchive, boolean bool, boolean shouldAppend) {

        try (BufferedWriter addArchive = new BufferedWriter(new FileWriter(this.router+nameArchive+".txt", shouldAppend))) { // 'true' permite agregar al archivo existente
            if (content.trim().isEmpty() || nameArchive.isEmpty()){
                throw new NullPointerException(" EL contenido es requerido. ");
            }
